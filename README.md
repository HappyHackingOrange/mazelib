...
The following code example implements a game engine which displays the maze on a terminal window.  The game engine is implemented through the View interface class--it allows for flexiblity if you want to design a different game engine with same maze generator/solver.
